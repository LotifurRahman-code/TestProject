...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    private void fillSurahListable() {
        ...
        MainList surah2 = new MainList(2, "রফিক সাহেব ঠিক করলেন, ছেলের বিয়ে দেবেন। ছেলেকে গিয়ে বললেন, শোন, আমি ঠিক করেছি তোর বিয়ে দেবো। পাত্রীও ঠিক।\n" +
                "প্রেসিডেন্ট : তাহলে আমি রাজি!\n", "মক্কা", 7);
        addSurahList(surah2);

        MainList surah3 = new MainList(3, "রফিক সাহেব ঠিক করলেন, ছেলের বিয়ে দেবেন। ছেলেকে গিয়ে বললেন, শোন, আমি ঠিক করেছি তোর বিয়ে দেবো। পাত্রীও ঠিক।\n" +
                "ছেলে : কিন্তু বাবা আমি তো নিজের পছন্দে বিয়ে করতে চাই!\n" +
        ...
        MainList surah4 = new MainList(4, "রফিক সাহেব ঠিক করলেন, ছেলের বিয়ে দেবেন। ছেলেকে গিয়ে বললেন, শোন, আমি ঠিক করেছি তোর বিয়ে দেবো। পাত্রীও ঠিক।\n" +
                "ছেলে : কিন্তু বাবা আমি তো নিজের পছন্দে বিয়ে করতে চাই!\n" +
                "রফিক সাহেব : পাত্রী বিল গেটসের মেয়ে।\n" +
                "ছেলে : তাহলে বাবা আমি রাজি!\n" +
                "প্রেসিডেন্ট : তাহলে আমি রাজি!\n", "মক্কা", 910);
